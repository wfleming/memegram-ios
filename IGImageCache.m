 ...
 * if it's not there, it pulls it down, rights it to disk, & returns it.
 */
@implementation IGImageCache
...
+ (UIImage*) getImageAtURL:(NSString*)url {
  ...
  if ([[NSFileManager defaultManager] fileExistsAtPath:cachePath]) {
    ...
    IGResponse *response = [IGConnection get:url];
